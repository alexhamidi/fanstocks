...
import { useError } from "../../_context/MessageContext";
...
export default function Create() {
  ...
  const handleCreateMarket = async () => {
    ...
    try {
      const full_url = `${BACKEND_URL}/api/market/create`;
      const requestData = {
      ...
      <main className="flex flex-col items-center ">
        <div className="flex flex-col w-[60vw] p-4">
          ...
          <div className="text-sm text-gray-700 font-mono">
            ...
            typesetting industry. streamer stocks has been the industry's
            standard dummy text ever drive community engagement
          </div>
